...
#define WORK_DIR    "/storage/emulated/0/Android/data/com.aicent.tpu/files/Documents/resource"

static std::mutex g_mtx;

extern "C" JNIEXPORT jint JNICALL
Java_com_aicent_tpu_MainActivity_ImageProcessorInitialize(
        JNIEnv* env,
        jobject /* this */) {
...
extern "C" JNIEXPORT jint JNICALL
Java_com_aicent_tpu_MainActivity_ImageProcessorProcess(
        JNIEnv* env,
        jobject, /* this */
        jlong   objMat) {
...
extern "C" JNIEXPORT jint JNICALL
Java_com_aicent_tpu_MainActivity_ImageProcessorFinalize(
        JNIEnv* env,
        jobject /* this */) {
...
extern "C" JNIEXPORT jint JNICALL
Java_com_aicent_tpu_MainActivity_ImageProcessorCommand(
        JNIEnv* env,
        jobject, /* this */
        jint cmd) {
